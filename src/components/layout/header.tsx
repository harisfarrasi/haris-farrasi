    ...
    <header className="fixed top-0 left-0 right-0 z-50 p-4" ref={headerRef}>
      <div
        className={cn(
          ...
          'mx-auto max-w-max rounded-full border border-border bg-background/85 backdrop-blur-xl shadow-md',
          'px-4'
        )}
      >
        ...
        {isMenuOpen && (
          <div
            className={cn(
              ...
              'rounded-2xl border border-border bg-background/85 backdrop-blur-xl shadow-md',
