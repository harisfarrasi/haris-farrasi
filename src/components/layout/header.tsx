    ...
    <header className="fixed top-0 left-0 right-0 z-50 p-4" ref={headerRef}>
      ...
      >
        ...
        {isMenuOpen && (
          <div
            className={cn(
              'md:hidden absolute top-full w-screen max-w-xs left-1/2 -translate-x-1/2 mt-3',
              'origin-top transition-all duration-300 ease-out',
            )}
          >
            <div className="rounded-2xl border border-border bg-background/10 backdrop-blur-xl shadow-xl p-4">
