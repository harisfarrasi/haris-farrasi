    ...
    <footer id="contact" className="py-16 sm:py-24 border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="font-headline text-2xl md:text-3xl font-bold mb-4">Collaborate / Invest / Join</h3>
            <p className="text-lg text-muted-foreground mb-8">
              I'm always open to new ideas and collaborations. Let's connect and build the future together.
            </p>
